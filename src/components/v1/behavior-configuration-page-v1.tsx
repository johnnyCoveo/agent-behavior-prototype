...
import { AddBehaviorModalV1 } from '@/components/v1/add-behavior-modal-v1'
import { AppSidebarV1 } from '@/components/v1/app-sidebar-v1'
import { BehaviorDetailPageV1 } from '@/components/v1/behavior-detail-page-v1'
...
export function BehaviorConfigurationPageV1() {
          ...
          <div className="min-w-0 flex-1 overflow-y-auto bg-[#f9f9fa] px-8 py-10">
            {selectedAgent ? (
              <div className="mx-auto max-w-[1240px] space-y-10">
                ...
                <section className="w-full max-w-[70%] min-w-[52rem] space-y-6">
                    ...
                    <div className="space-y-4">
                      {behaviors.map((behavior) => (
                        <button
                          ...
                          className="w-full rounded-[8px] border border-[#dddfe3] bg-white px-6 py-5 text-left shadow-[0px_1px_2px_0px_rgba(0,0,0,0.10),0px_1px_3px_0px_rgba(0,0,0,0.05),0px_-0.5px_1px_0px_rgba(0,0,0,0.02)] transition hover:border-[#b9bdc7] hover:bg-[#fcfcfd]"
                        >
                          <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                              ...
                              <div className="space-y-2">
                                <div className="flex flex-wrap items-center gap-2">
                                  ...
                                  <span
                                    className={
                                      behavior.enabled
                                        ? 'inline-flex rounded-full bg-[#e5fff9] px-2.5 py-1 text-[12px] leading-4 text-[#077b6b]'
                                        : 'inline-flex rounded-full bg-[#f1f2f4] px-2.5 py-1 text-[12px] leading-4 text-[#676d7a]'
                                    }
                                  >
                                    {behavior.enabled ? 'Enabled' : 'Disabled'}
                                  </span>
                                  {behaviorCardMetrics[behavior.id]?.needsReview ? (
                                    <span className="inline-flex rounded-full bg-[#fff2c0] px-2.5 py-1 text-[12px] font-medium leading-4 text-[#936400]">
                                      Needs review
                                    </span>
                                  ) : null}
                                </div>
                            ...
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:min-w-[19rem] xl:max-w-[20rem]">
                              <div className="rounded-[12px] border border-[#dddfe3] bg-[#fbfcfd] px-4 py-3">
                                <p className="text-[12px] leading-4 text-[#676d7a]">Trigger count</p>
                                <p className="mt-1 text-[16px] font-medium leading-5 text-[#282829]">
                                  {behaviorCardMetrics[behavior.id]?.triggerCount ?? '0'}
                                </p>
                              </div>
                              <div className="rounded-[12px] border border-[#dddfe3] bg-[#fbfcfd] px-4 py-3">
                                <p className="text-[12px] leading-4 text-[#676d7a]">Success rate</p>
                                <p className="mt-1 text-[16px] font-medium leading-5 text-[#282829]">
